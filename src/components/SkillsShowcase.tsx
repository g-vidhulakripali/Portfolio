...
export const SkillsShowcase = () => {
  ...
  const languages = [
    { name: "English", level: "C1", color: "bg-blue-500" },
    { name: "German", level: "A2", color: "bg-green-500" },
    { name: "Tamil", level: "Native", color: "bg-purple-500" },
  ];
  ...
  return (
    <section className="container mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="bg-white/10 backdrop-blur-sm border-gray-700/50">
          <CardContent className="p-6">
            <div className="flex items-center mb-6">
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {["Leadership", "Communication", "Problem Solving", "Team Work", "Time Management", "Adaptability"].map((skill) => (
                <div key={skill} className="p-3 bg-slate-800/50 rounded-lg text-center text-gray-300 hover:bg-slate-800/70 transition-colors">
                  {skill}
                </div>
              ))}
            </div>
